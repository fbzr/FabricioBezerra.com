...
app.post(
  ...
  async (req, res) => {
    ...
    // Node Mailer
    const output =
      "<p>You have a new message from FabricioBezerra.com</p><h3>Contact Details</h3><ul><li>Name: " +
      name +
      "</li><li>Email: " +
      email +
      "</li></ul><h3>Message:</h3><p>" +
      message +
      "</p>";
    ...
    res
      .status(200)
      .json({ msg: "Thank you for conctacting me. I'll be in touch soon." });
  }
);
